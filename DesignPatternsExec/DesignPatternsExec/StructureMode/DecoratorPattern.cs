...
namespace DesignPatternsExec
{
    ...
    public sealed class CJJHouse : MyHouse
    {
        public override void Renovation()
        {
            Console.WriteLine("This is CJJ House");
        }
    }
    public class MyDecorator : MyHouse
    {
        MyHouse _myHouse;
        public MyDecorator(MyHouse myHouse)
        {
            _myHouse = myHouse;
        }
        public override void Renovation()
    ...
    public class MyDecorator2 : MyHouse
    {
        MyHouse _myHouse;
        public MyDecorator2(MyHouse myHouse)
        {
            _myHouse = myHouse;
        }
        public override void Renovation()
    ...
    public class DecoratorPattern
    {
        public void Show()
        {
            MyHouse myHouse = new CJJHouse();

            MyHouse afterDecorator = new MyDecorator(myHouse);
            afterDecorator.Renovation();

            MyHouse affterDecorator = new MyDecorator2(afterDecorator);
            affterDecorator.Renovation();


            //这就是我们的饺子馅，需要装饰的房子
            House myselfHouse = new StarDengHouse();

            House securityHouse = new HouseSecurityDecorator(myselfHouse);
    ...
    /// <summary>
    /// StarDeng的房子，我要按我的要求做房子，相当于ConcreteComponent类型，这就是我们具体的饺子馅，我个人比较喜欢韭菜馅
    /// </summary>
